...
class DocumentIT extends IntegrationBase {
    ...
    /**
     * DELETE /document-uploads/{id} must return 204 and remove the document from MongoDB.
     * This is a user-facing endpoint (frontend calls it on remove) — no admin secret required.
     */
    @Test
