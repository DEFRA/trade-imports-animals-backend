...
- Name: e2e/pages/origin.spec.ts >> Origin of the import page >> shows an error summary when submitted without a country
- Location: tests/e2e/pages/origin.spec.ts:27:3
