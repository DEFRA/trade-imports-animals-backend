...
- Location: tests/e2e/visual/origin-of-import.visual.spec.ts:12:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1332px, received 1280px by 1417px. 78622 pixels (ratio 0.05 of all image pixels) are different.
        ...
        - generic [ref=e51]:
          ...
          - generic [ref=e77]:
            ...
            - link "Cancel and return to hub" [ref=e80] [cursor=pointer]:
              - /url: /notifications/GBN-AG-26-S2VVPQ
  - contentinfo [ref=e81]:
    - generic [ref=e94]:
      - generic [ref=e95]:
...
```ts
  ...
  9  |   });
  10 | 
  11 |   // No mask: the page no longer shows the signed-in user's email address, so there is nothing varying to hide.
  12 |   test('shows expected page appearance on first load', async ({ page }) => {
> 13 |     await expect(page).toHaveScreenshot('origin-of-import.png', { fullPage: true });
     |                        ^ Error: expect(page).toHaveScreenshot(expected) failed
  14 |   });
  15 | });
  16 | 
